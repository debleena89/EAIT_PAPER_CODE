...
#-----generates the combination tree and return the tree----
    ...
    print("How many control loops are sharing the bus:")   
    number_of_control_loops = raw_input()
   
    
   for index in range(0, int(number_of_control_loops))
       print("enter the elemnnt for control loop ", index)
       print("how many state it has")
       control_loop_state_number = raw_input()
       for state_number_index in range
